...
Route::middleware(['auth', 'role:admin', 'admin.ip'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/bookings/{id}/checkin', [AdminBookingController::class, 'checkin'])->name('bookings.checkin');
        ...
        Route::get('/assets/next-serial', [AssetController::class, 'getNextSerialNumber'])->name('assets.next_serial');
