            ...
            <form action="{{ route('admin.assets.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="serial_number" class="form-control bg-light" placeholder="Auto-generated (e.g. SN-...)" readonly required>
                    </div>
                    <div class="col-md-6">
