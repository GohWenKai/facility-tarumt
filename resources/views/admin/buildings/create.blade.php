    ...
    <div class="page-header mb-4">
        <div class="d-flex align-items-center gap-3">
            ...
            <div>
                ...
                <p class="page-subtitle text-muted mb-0">Create a new campus building for facilities</p>
            </div>
        </div>
    </div>
        ...
        <div class="card-body p-4">
            <form action="{{ route('admin.buildings.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <div class="input-group-custom">
                                ...
                                <input type="text" name="name" class="form-control-custom" placeholder="e.g., Block A (Admin)" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group-custom">
                                ...
                                <input type="text" name="location" class="form-control-custom" placeholder="e.g., Main Campus, West Wing" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <label class="form-label-custom">Upload Image (Optional)</label>
                        ...
                        <div class="col-md-6">
                            <div class="image-previews" id="previewContainer" style="display: none;">
...
<style>
/* ========================================
   CREATE BUILDING - PURPLE/EMERALD THEME (Create = Green accent)
   ======================================== */

.page-header { border-bottom: 1px solid #e2e8f0; padding-bottom: 1.5rem; }
.btn-back { display: flex; align-items: center; justify-content: center; width: 42px; height: 42px; border-radius: 12px; background: #d1fae5; color: #059669; text-decoration: none; transition: all 0.2s ease; }
.btn-back:hover { background: #a7f3d0; color: #047857; }
...
.form-card { border: 1px solid #a7f3d0; border-radius: 16px; box-shadow: 0 4px 6px -1px rgba(5, 150, 105, 0.1); }
.form-section { padding: 1.5rem 0; border-bottom: 1px solid #d1fae5; }
.form-section:last-of-type { border-bottom: none; }
.section-header { display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1.5rem; }
.section-icon { display: flex; align-items: center; justify-content: center; width: 36px; height: 36px; border-radius: 10px; background: linear-gradient(135deg, #34d399 0%, #059669 100%); color: white; font-size: 1rem; }
...
.input-icon { position: absolute; left: 14px; color: #059669; font-size: 1rem; z-index: 1; }
.form-control-custom { width: 100%; padding: 0.875rem 1rem 0.875rem 2.75rem; border: 2px solid #a7f3d0; border-radius: 12px; font-size: 0.95rem; transition: all 0.2s ease; background: #fff; }
.form-control-custom:focus { outline: none; border-color: #10b981; box-shadow: 0 0 0 4px rgba(16, 185, 129, 0.1); }

/* Image Upload */
.image-upload-area { position: relative; border: 2px dashed #a7f3d0; border-radius: 12px; padding: 2rem; text-align: center; cursor: pointer; transition: all 0.2s ease; }
.image-upload-area:hover { border-color: #10b981; background: #ecfdf5; }
.image-upload-area input { position: absolute; inset: 0; opacity: 0; cursor: pointer; }
.upload-placeholder { display: flex; flex-direction: column; align-items: center; gap: 0.5rem; color: #047857; }
.upload-placeholder i { font-size: 2rem; color: #10b981; }
.image-previews { display: flex; gap: 1rem; }
.preview-item { text-align: center; }
.preview-item small { display: block; font-weight: 600; color: #059669; margin-bottom: 0.5rem; }
.preview-item img { width: 150px; height: 100px; object-fit: cover; border-radius: 8px; border: 2px solid #10b981; }

/* Form Actions */
.form-actions { display: flex; justify-content: flex-end; gap: 1rem; padding-top: 2rem; margin-top: 1rem; border-top: 1px solid #d1fae5; }
...
.btn-submit { display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.875rem 2rem; border: none; border-radius: 12px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; font-weight: 600; cursor: pointer; transition: all 0.2s ease; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3); }
