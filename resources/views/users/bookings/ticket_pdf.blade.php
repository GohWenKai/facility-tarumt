    ...
    <div class="ticket">
        ...
        <div class="content">
            ...
            <div style="text-align: center; margin-top: 20px; padding: 15px; background: #f7fafc; border-radius: 8px;">
                ...
                <div style="display: inline-block; padding: 10px; background: white; border: 2px solid #e2e8f0; border-radius: 8px;">
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data={{ urlencode($data['id']) }}" alt="QR Code" width="100" height="100">
                </div>
